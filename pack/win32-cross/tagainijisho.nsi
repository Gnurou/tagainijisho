...
File "${BUILDDIR}/src/sqlite/tagainijisho_sqlite.dll"
File "${BUILDDIR}/src/core/tagainijisho_core.dll"
File "${BUILDDIR}/*.db"
...
Delete "$INSTDIR\export_template.html"
Delete "$INSTDIR\*.db"
Delete "$INSTDIR\tagainijisho_core.dll"
Delete "$INSTDIR\tagainijisho_sqlite.dll"
