...
File "${BUILDDIR}/src/sqlite/libtagaini_sqlite.dll"
File "${BUILDDIR}/src/core/libtagaini_core.dll"
File "${BUILDDIR}/*.db"
...
Delete "$INSTDIR\export_template.html"
Delete "$INSTDIR\*.db"
Delete "$INSTDIR\libtagaini_core.dll"
Delete "$INSTDIR\libtagaini_sqlite.dll"
