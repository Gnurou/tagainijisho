...
public:
    ...
    void cleanup();
    bool fetchNext(_QSqlCachedResult::ValueCache &values, int idx, bool initialFetch);
...
bool QSQLiteResultPrivate::fetchNext(_QSqlCachedResult::ValueCache &values, int idx, bool initialFetch)
{
    int res;
    int i;
...
void QSQLiteResult::virtual_hook(int id, void *data)
{
    ...
    case QSqlResult::DetachFromResultSet:
        ...
        break;
    default:
        _QSqlCachedResult::virtual_hook(id, data);
    }
}
...
bool QSQLiteResult::gotoNext(_QSqlCachedResult::ValueCache& row, int idx)
{
