...
class EntryDelegatePreferences : public QWidget, private Ui::EntryDelegatePreferences {
  ...
  private:
    ...
    void applyFontSetting(PreferencesFontChooser *fontChooser, PreferenceItem<QString> *prefItem,
  ...
  public:
     ...
     * is performed!
     */
    void setPrefsToWatch(PreferenceItem<int> *twoLinesPref,
...
class ResultsViewPreferences : public PreferencesWindowCategory,
                               private Ui::ResultsViewPreferences {
    Q_OBJECT
  private:
    ResultsList *_list;
    ResultsView *_view;
...
class DetailedViewPreferences : public PreferencesWindowCategory,
                                private Ui::DetailedViewPreferences {
    Q_OBJECT
  private:
    PreferencesFontChooser *romajifontChooser;
...
class PreferencesFontChooser : public QWidget {
  ...
  public:
    PreferencesFontChooser(const QString &whatFor, const QFont &defaultFont = QFont(),
                           QWidget *parent = 0);
