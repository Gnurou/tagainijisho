...
class TemplateFiller {
  public:
    ...
    /**
     * Extracts the requested parts from the template. Parts are delimited using
     * the PART tag enclosed into HTML comments. The last argument specifies
     * whether text that is not in any part should be included or not.
     */
