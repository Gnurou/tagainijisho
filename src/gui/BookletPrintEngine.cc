...
BookletPrintEngine::BookletPrintEngine(QPrinter *printer)
    : QPrintEngine(), ProxyPaintEngine(printer), _printer(printer), _engine(printer->printEngine()),
      _pageCpt(0) {}
...
void BookletPrintEngine::drawPageLayout() {
    ...
    painter->drawLine(QPoint(window.center().x(), window.top()),
                      QPoint(window.center().x(), window.bottom()));
    painter->drawLine(QPoint(window.left(), (window.top() + _subPageWidth)),
                      QPoint(window.right(), (window.top() + _subPageWidth)));
    painter->drawLine(QPoint(window.left(), (window.top() + _subPageWidth * 2)),
                      QPoint(window.right(), (window.top() + _subPageWidth * 2)));
    painter->drawLine(QPoint(window.left(), (window.top() + _subPageWidth * 3)),
                      QPoint(window.right(), (window.top() + _subPageWidth * 3)));
}
...
QPrinter::PrinterState BookletPrintEngine::printerState() const { return _engine->printerState(); }
...
bool BookletPrintEngine::end() { return ProxyPaintEngine::end(); }
